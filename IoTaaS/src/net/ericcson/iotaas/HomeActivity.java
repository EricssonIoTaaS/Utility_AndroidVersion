...
public class HomeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			AttempReadData(object,"16714748","http://10.173.130.218:25003");
		} catch (Exception e) {
		}

	}

	public boolean AttempReadData(URL object,String objname,String RAdress)
	{
		...
		try {
			...
			wout.write("<?xml version=\"1.0\" encoding=\"UTF-8\"?><tns:CreateMeterReadings xmlns:tns=\"http://iec.ch/TC57/2011/MeterReadingsMessage\" xmlns:msg=\"http://iec.ch/TC57/2011/schema/message\" xmlns:obj=\"http://iec.ch/TC57/2011/MeterReadings#\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://iec.ch/TC57/2011/MeterReadingsMessage ../xsd/MeterReadingsMessage.xsd\"><tns:Header><msg:Verb>create</msg:Verb><msg:Noun>MeterReadings</msg:Noun><msg:Revision>0.1</msg:Revision><msg:Timestamp>2014-12-17T09:30:41.0Z</msg:Timestamp><msg:ReplyAddress>"+RAdress+"</msg:ReplyAddress><msg:CorrelationID>123123</msg:CorrelationID></tns:Header><tns:Payload><obj:MeterReadings><obj:MeterReading><obj:Meter><obj:Names><obj:name>"+objname+"</obj:name></obj:Names></obj:Meter></obj:MeterReading><obj:ReadingType><obj:Names><obj:name>0.0.0.1.1.1.12.0.0.0.0.0.0.0.0.3.72.0</obj:name></obj:Names></obj:ReadingType></obj:MeterReadings></tns:Payload></tns:CreateMeterReadings>");
